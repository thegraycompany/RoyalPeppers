...
interface IState {
  Spint: any;
  isVisibleSpint: boolean,

  Rups: any;
  isVisibleRups: boolean,

  WitteVlieg: any;
  isVisibleWitteVlieg: boolean,

  Trips: any;
  isVisibleTrips: boolean,

  Luis: any;
  isVisibleLuis: boolean,

  FruitMot: any;
  isVisibleFruitMot: boolean,

  Kevers: any;
  isVisibleKevers: boolean,

  Fusarium: any;
  isVisibleFusarium: boolean,

  Pythium: any;
  isVisiblePythium: boolean,

  MineerVlieg: any;
  isVisibleMineerVlieg: boolean,

  Meeldauw: any;
  isVisibleMeeldauw: boolean,

  Wants: any;
  isVisibleWants: boolean,
...
export class ScoutMistakes extends React.Component<IProps, IState> {
  public eventHandlers = {
    onChangeKas: (text: string) => this.onChangeKas(text),
    onChangeOverig: (text: string) => this.onChangeOverig(text),
        ...
        <ScrollView>
          ...
          <View style={styles.dropdown}>
            ...
            <DropDownPicker
              ...
              placeholder="Selecteer een pootpoot"
  ...
  onChangeKas(text: string) {
    this.setState({ Kas: text });
  }

  onChangeOverig(text: string) {
